...
#' @param shape 'long' or 'wide' indicating whether summary statistics should be separate columns (wide)
#'              or assigned to separate rows, with the name of the summary statistic in the site column (long)
#'
