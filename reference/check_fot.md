...
ndq::fot_input_omop
#> # A tibble: 22 × 7
#>    check_id  check_description check_domain schema table date_field filter_logic
#>    <chr>     <chr>             <chr>        <chr>  <chr> <chr>      <chr>       
#>  1 vi        all visits        visits       cdm    visi… visit_sta… NA          
#>  2 vo_office outpatient visits visits       cdm    visi… visit_sta… visit_conce…
#>  3 vo_labs   outpatient lab v… visits       cdm    visi… visit_sta… visit_conce…
#>  4 vo_th     telehealth visits visits       cdm    visi… visit_sta… visit_conce…
#>  5 vo_oa     other ambulatory… visits       cdm    visi… visit_sta… visit_conce…
#>  6 vip       inpatient visits… visits       cdm    visi… visit_sta… visit_conce…
#>  7 ved       emergency depart… visits       cdm    visi… visit_sta… visit_conce…
#>  8 vob       observation visi… visits       cdm    visi… visit_sta… visit_conce…
#>  9 co        all conditions    conditions   cdm    cond… condition… NA          
#> 10 dp        prescription dru… drugs        cdm    drug… drug_expo… drug_type_c…
#> # ℹ 12 more rows
ndq::fot_input_pcornet
#> # A tibble: 21 × 7
#>    check_id  check_description check_domain schema table date_field filter_logic
#>    <chr>     <chr>             <chr>        <chr>  <chr> <chr>      <chr>       
#>  1 vi        all visits        visits       cdm    enco… admit_date NA          
#>  2 vo_office outpatient visits visits       cdm    enco… admit_date enc_type ==…
#>  3 vo_th     telehealth visits visits       cdm    enco… admit_date enc_type ==…
#>  4 vo_oa     other ambulatory… visits       cdm    enco… admit_date enc_type ==…
#>  5 vip       inpatient visits… visits       cdm    enco… admit_date enc_type %i…
#>  6 ved       emergency depart… visits       cdm    enco… admit_date enc_type ==…
#>  7 vob       observation visi… visits       cdm    enco… admit_date enc_type ==…
#>  8 co        all diagnoses     conditions   cdm    diag… admit_date NA          
#>  9 dp        prescription dru… drugs        cdm    pres… rx_start_… NA          
#> 10 ip        inpatient admini… drugs        cdm    med_… medadmin_… NA          
#> # ℹ 11 more rows
