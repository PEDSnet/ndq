...
Intakes the output of `check_qvd` in order to apply additional
...
``` r
process_qvd(qvd_results, rslt_source = "remote", csv_rslt_path = NULL)
```
...
- qvd_results:
  ...
  *tabular input* \|\| **required**
  ...
  The tabular output of `check_qvd`. This table should include results
